...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "https://github.com/vsanthanam/SafariView.git", .upToNextMajor(from: "3.0.0")),
        ...
        .package(url: "https://github.com/pointfreeco/swift-composable-architecture.git", .upToNextMajor(from: "1.1.0")),
    ],
    targets: [
        .target(
            name: "WebSocketClientPackage",
